...
const Ingrediente = (props) => {
    ...
    return (<>
        <div className="ingrediente">
            ...
            <p>{nome}</p>
            <p>R$ {preco}</p>
            <button className="btn btn-primary" onClick={selecionar}>{selecionado ? "Desselecionar" : "Selecionar"}</button>
        </div>
    </>);
}
                ...
                <div className="row m-5 section">
                    ...
                    <form action="Administrador Gerir Ingredientes.html" method="post">
                        ...
                        <div className="form-group mb-2">
                            ...
                            <input type="number" className="form-control" id="preco" name="preco" placeholder="Preço" autoComplete="off" />
                        </div>
                        <div className="form-group mb-2">
                            <label htmlFor="descricao">Descrição</label>
                            <input type="text" className="form-control" id="descricao" name="descricao" placeholder="Descrição" autoComplete="off" />
                        </div>
                        <div className="form-group mb-2">
                            <label htmlFor="descricao">Peso Porção</label>
                            <input type="number" className="form-control" id="descricao" name="descricao" placeholder="Peso Porção" min="1" max="100" autoComplete="off" />
                        </div>
                        <div className="form-group mb-2">
